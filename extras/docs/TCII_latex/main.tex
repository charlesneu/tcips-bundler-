...
%Pre-textual
%\input{pre-textual/aprovacao.tex}
%\input{pre-textual/01.dedicatoria.tex}
\input{pre-textual/02.agradecimentos.tex}
\input{pre-textual/epigrafe.tex}
\input{pre-textual/03.resumo.tex}
\input{pre-textual/04.abstract.tex}
\listoffigures
\listoftables
\lstlistoflistings
\input{pre-textual/05.abbr.tex}
...
%Textual
\input{textual/01.introducao/00.main.tex}
\input{textual/02.fundamentacao/00.main.tex}
\input{textual/03.trabalhos-relacionados/00.main.tex}
\input{textual/04.proposta/00.main.tex}
\input{textual/05.avaliacao/00.main.tex}
\input{textual/06.consideracoes/00.main.tex}
